...
namespace Vendas.DAL
{
    class VendaDAO
    {
        ...
        public static List<Venda> BuscarVendasPorCliente(Cliente c)
        {
            ...
            //listaDeVendasAux = new List<Venda>();
        ...
        public static List<Venda> BuscarVendasPorFormaDePagamento(FormaDePagamento pagamento)
        {
            return ctx.Vendas.Include("Cliente").
                ...
                Include("FormaDePagamento").
                Include("ListaDeProdutos.Produto").
                Where(x => x.FormaDePagamento.Nome.Equals(pagamento.Nome)).ToList();
        //{
        //    listaDeVendasAux = new List<Venda>();
        //    foreach (Venda vendaCadastrada in listaDeVendas)
        //    {
        //        if (vendaCadastrada.FormaDePagamento.Nome.Equals(pagamento.Nome))
        //        {
        //            listaDeVendasAux.Add(vendaCadastrada);
        //        }
        //    }
